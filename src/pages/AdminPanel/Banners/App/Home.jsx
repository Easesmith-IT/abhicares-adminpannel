...
const Home = () => {
  ...
  const uploadImages = async () => {
    ...
    formDataBan1.append("page", "home");
    formDataBan1.append("section", "app-homepage");
    ...
    formDataBan2.append("page", "home");
    formDataBan2.append("section", "app-homepage");
